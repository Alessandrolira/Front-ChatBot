      ...
      <div className="bg-(--cinza) w-full h-full rounded-lg flex">
        ...
        <div className="text-(--branco) w-[72%] rounded-lg flex flex-col relative">
          <div className="flex justify-end p-[2em] items-center">
            <Link href="/usuario"><div className="rounded-full w-[3em] h-[3em] bg-(--background) mr-[2em] flex items-center justify-center shadow-lg shadow-black cursor-pointer transition duration-300 ease-in-out inset-shadow-sm inset-shadow-black/30 hover:bg-[var(--azulw3-hover)]">
